...
$optionSets = @(
    ...
    @{
        ...
        Options = @(
            @{ Value = 595300000; Label = "Update Source" }
            @{ Value = 595300001; Label = "Create Source" }
            @{ Value = 595300002; Label = "Delete Source" }
            @{ Value = 595300003; Label = "Multi-Source" }
            @{ Value = 595300004; Label = "Merge" }
            @{ Value = 595300005; Label = "Custom API" }
            @{ Value = 595300006; Label = "Config" }
            @{ Value = 595300007; Label = "End-to-End" }
            @{ Value = 595300008; Label = "Error Handling" }
        )
    },
    @{
