...
SPECS = {
    "jbe_testcase": {
        "active": (
            ...
            [("jbe_name",200), ("jbe_testid",110), ("jbe_title",240), ("jbe_category",130),
             ("jbe_domain",120), ("jbe_testlevel",110), ("jbe_tags",160),
             ("jbe_enabled",70), ("jbe_lifecyclestatus",120), ("modifiedon",120)],
            '<condition attribute="statecode" operator="eq" value="0" />',
            "jbe_testid", False, "jbe_testid"),
        "inactive": (
            "Inaktive Testfälle", "Inactive Test Cases", QT_MAIN, False,
            [("jbe_name",200), ("jbe_testid",110), ("jbe_title",240), ("jbe_category",130),
             ("jbe_enabled",70), ("modifiedon",120)],
    ...
    "jbe_testrun": {
        "active": (
            ...
            [("jbe_name",200), ("jbe_teststatus",110), ("jbe_total",60),
             ("jbe_passed",60), ("jbe_failed",60), ("jbe_skipped",60), ("jbe_errored",60),
             ("jbe_testcasefilter",150), ("jbe_startedon",130), ("jbe_completedon",130),
             ("jbe_durationms",90)],
            '<condition attribute="statecode" operator="eq" value="0" />',
        ...
        "quickfind": (
            ...
            [("jbe_name",200), ("jbe_teststatus",110), ("jbe_testcasefilter",150),
             ("jbe_total",60), ("jbe_passed",60), ("jbe_failed",60), ("jbe_skipped",60)],
            '<condition attribute="statecode" operator="eq" value="0" />',
            "modifiedon", True, "jbe_name",
        ...
        "assoc": (
            ...
            [("jbe_name",200), ("jbe_teststatus",110), ("jbe_total",60),
             ("jbe_passed",60), ("jbe_failed",60), ("jbe_skipped",60), ("createdon",140)],
            '<condition attribute="statecode" operator="eq" value="0" />',
            "modifiedon", True, "jbe_name"),
        "lookup": (
    ...
    "jbe_testrunresult": {
        "active": (
            ...
            [("jbe_name",150), ("jbe_testid",110), ("jbe_outcome",100), ("jbe_durationms",90),
             ("jbe_errormessage",300), ("jbe_testrunid",160), ("modifiedon",120)],
            '<condition attribute="statecode" operator="eq" value="0" />',
            "modifiedon", True, "jbe_name"),
        "inactive": (
            "Inaktive Testergebnisse", "Inactive Test Run Results", QT_MAIN, False,
            [("jbe_name",150), ("jbe_testid",110), ("jbe_outcome",100), ("jbe_testrunid",160),
             ("modifiedon",140)],
            '<condition attribute="statecode" operator="eq" value="1" />',
            "modifiedon", True, "jbe_name"),
        "quickfind": (
            ...
            [("jbe_name",150), ("jbe_testid",110), ("jbe_outcome",100), ("jbe_durationms",90),
             ("jbe_errormessage",300), ("jbe_testrunid",160)],
            '<condition attribute="statecode" operator="eq" value="0" />',
            "modifiedon", True, "jbe_name",
    ...
    "jbe_teststep": {
        "active": (
            ...
            [("jbe_name",150), ("jbe_stepnumber",70),
             ("jbe_action",120), ("jbe_entity",130), ("jbe_stepstatus",100),
             ("jbe_durationms",90), ("jbe_testrunresultid",160)],
            '<condition attribute="statecode" operator="eq" value="0" />',
        ...
        "assoc": (
            ...
            [("jbe_name",180), ("jbe_stepnumber",60),
    ...
    "jbe_testrun": [
        {
            ...
            "spec": (
                ...
                [("jbe_name",200), ("jbe_teststatus",110), ("jbe_total",60),
                 ("jbe_passed",60), ("jbe_failed",60), ("jbe_skipped",60), ("jbe_errored",60),
                 ("jbe_testcasefilter",150), ("jbe_startedon",130)],
                # Status != Completed
                '<condition attribute="statecode" operator="eq" value="0" />\n'
    ...
    "jbe_testrunresult": [
        {
            ...
            "spec": (
                ...
                [("jbe_name",150), ("jbe_testid",110), ("jbe_outcome",100), ("jbe_errormessage",400),
                 ("jbe_durationms",90), ("jbe_testrunid",160), ("modifiedon",120)],
                '<condition attribute="statecode" operator="eq" value="0" />\n'
