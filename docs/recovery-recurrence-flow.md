...
The flow is not part of the shipped solution, because its connection reference is specific to each
environment. It is a `workflow` record (`category=5`) and is created, added to the solution and activated
