...
{ "stepNumber": 5, "action": "ExecuteRequest",
  "requestName": "contoso_CancelInvoice",
  "outputAlias": "cancel",
...
{ "stepNumber": 2, "action": "CreateRecord",
  "entity": "contoso_bestellungs",
  "alias": "pos",
  "fields": {
    "contoso_beschreibung": "JBE Test Position {TIMESTAMP}",
    "contoso_beginnzeitpunkt": "2027-01-01",
    "contoso_ende": "2027-03-31",
    "contoso_nettobetrag": 3000,
    "contoso_umsatzverteilung": 105710000,
    "contoso_leistungid@odata.bind": "/contoso_leistungs({leistung.id})"
  },
  "cleanupChildren": [
...
{ "stepNumber": 1, "action": "CreateRecord",
  "entity": "contoso_leistungs",
  "alias": "leistung",
  "fields": { "contoso_bezeichnung": "JBE Test Leistung {TIMESTAMP}", "contoso_gesamtausgaben": 0 },
  "cleanupChildren": [
    { "entity": "contoso_umsatzplans", "lookupField": "contoso_leistungid" }
  ] }
```
...
```
Cleanup...
    Cleanup-Kinder: 3x 'contoso_umsatzplans' via 'contoso_bestellungid' von contoso_bestellung <id> gelöscht
    Bereits gelöscht (kaskadiert): contoso_bestellung <id>
