...
```json
{
  ...
  "category":    "Optional",
  "tags":        ["optional", "array"],
  "userStories": "PROJ-1234 PROJ-5678",
  "enabled":     true,
  "steps": [
    { "stepNumber": 1, "action": "...", "...": "..." },
    { "stepNumber": 2, "action": "...", "...": "..." }
...
| `userStories` | String | nein | Ticket-Referenzen, z.B. `"PROJ-1234 PROJ-5678"`. Nur Dokumentation. |
...
```json
{
  ...
  "description": "Testet ob bei Szenario A die Golden-Record-ID vom GR auf den Survivor (Duplikat) transferiert wird. Hintergrund: Projekt-Ticket PROJ-8113.",
  "category":    "Merge",
  "tags":        ["merge", "golden-record", "proj-8113"],
  "userStories": "PROJ-8113",
  "enabled":     true,
  "steps": [
