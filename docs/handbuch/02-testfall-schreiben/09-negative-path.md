...
- EnvVar `contoso_feature_enabled` zurück auf Original.
- Contact `c` gelöscht.
...
Belegt durch Repro-Tests gegen eine Custom API mit leerer
(`ContactIds: "[]"`) bzw. sehr großer ID-Liste (201 GUIDs) plus
