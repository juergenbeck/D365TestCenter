...
Integrationstests schreiben, ausfuehren und auswerten. Alles was du hier
brauchst, kannst du in der Model-Driven-App in Dynamics 365 machen —
kein CLI, kein PowerShell, kein Deployment-Tool.

## Voraussetzungen

- Dynamics 365 / Dataverse-Grundkenntnisse: du weisst was Entity,
...
Ein Integrations-Testframework fuer Dynamics 365. Tests werden als JSON
definiert, als Record in die Entity `jbe_testcase` gespeichert, und durch
einen `jbe_testrun`-Record gestartet. Die Ausfuehrung laeuft automatisch
als Async-Plugin im Server und protokolliert jeden Schritt als
`jbe_teststep`-Record. Mehr dazu in
[01-einfuehrung/01-was-ist-das-test-center.md](01-einfuehrung/01-was-ist-das-test-center.md).

## Lese-Pfade

### Neu hier? Starte hier.

1. [Was ist das Test Center?](01-einfuehrung/01-was-ist-das-test-center.md) — 5 Min Ueberblick
2. [Entity-Modell](01-einfuehrung/02-entity-modell.md) — welche Records spielen zusammen
3. [Quickstart mit 5 Beispielen](01-einfuehrung/03-quickstart.md) — erste 10 Minuten
...
4. [Rezepte](02-testfall-schreiben/07-rezepte.md) — Vorlagen fuer Standard-Szenarien

### Du willst einen Test ausfuehren

1. [Testfall in der App anlegen](03-ausfuehren/01-testfall-in-app-anlegen.md)
2. [Testlauf starten](03-ausfuehren/02-testlauf-starten.md)

### Dein Test scheitert

1. [Entscheidungsbaum](05-troubleshooting/01-entscheidungsbaum.md) — systematisch zum Fehler
2. [Haeufige Fehler](05-troubleshooting/02-haeufige-fehler.md) — Top 12 mit Fix
3. [Fehleranalyse](04-auswerten/04-fehleranalyse.md) — FAILED vs ERROR verstehen

### Du suchst schnell ein JSON-Snippet

[Anhang A — Cheat Sheet](anhang/a-cheat-sheet.md) — 20 haeufige Patterns auf einer Seite
...
docs/handbuch/
  ...
  01-einfuehrung/                  Architektur, Entity-Modell, Quickstart
  02-testfall-schreiben/           Die Sprache: Schema, Actions, Platzhalter, Assertions
  03-ausfuehren/                   Test in der App anlegen und starten
  04-auswerten/                    Ergebnisse lesen, Steps-Tab, Fehleranalyse
  05-troubleshooting/              Entscheidungsbaum, haeufige Fehler, Timing
  anhang/                          Cheat Sheet, Glossar, Links
```

## Konventionen in diesem Handbuch

- **JSON-Beispiele** sind immer vollstaendig und lauffaehig, es sei denn
