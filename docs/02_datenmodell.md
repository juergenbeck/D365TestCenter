...
| `jbe_category`       | Kategorie           | OptionSet (Picklist)   | `jbe_testcategory`        | Recommended         | Testkategorie (Update Source, Merge, Custom API usw.)           |
| `jbe_tags`           | Tags                | String                 | Zeichenkette              | None                | Kommagetrennte Tags, z.B. `LUW,SingleSource,Contact`               |
| `jbe_userstories`    | User Stories        | String                 | Zeichenkette              | None                | Kommagetrennte Jira-Keys, z.B. `PROJ-1234,PROJ-5678`                 |
...
| `jbe_testcasefilter`   | Testfall-Filter     | String                 | Zeichenkette              | None            | Filter-Ausdruck (`*`, `category:Merge`, `tag:smoke`, `story:PROJ-1234`, oder kommagetrennte IDs) |
...
| Code       | Label           | CONFIG-Konstante       |
|------------|-----------------|------------------------|
| 105710000  | Passed          | `outcomePassed`        |
...
| Code       | Label              | CONFIG-Konstante        |
|------------|--------------------|-------------------------|
| 105710000  | Update Source      | `catUpdateSource`       |
| 105710001  | Create Source      | `catCreateSource`       |
| 105710002  | Delete Source      | `catDeleteSource`       |
| 105710003  | Multi-Source       | `catMultiSource`        |
| 105710004  | Merge              | `catMerge`              |
| 105710005  | Custom API         | `catCustomApi`          |
| 105710006  | Config             | `catConfig`             |
| 105710007  | End-to-End         | `catEndToEnd`           |
| 105710008  | Error Handling     | `catErrorHandling`      |
