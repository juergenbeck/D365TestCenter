...
public sealed class InventoryEntry
{
    ...
    // Additive front-matter facts (parity with the earlier PowerShell inventory tooling). Empty when the
...
/// a static overview (status/domain roll-ups + a table per domain, adopting the vocabulary
/// of the earlier PowerShell inventory tooling) enriched with the run view (last run + stability trend)
