...
/// file IO live here; the pack assembly and lint are pure Core logic. Replaces earlier
/// project-specific PowerShell pack builders.
/// </summary>
public static class PackBuild
{
    // Directory segments that never contain test definitions (archive folders).
