...
/// <summary>
/// Bug report 2026-05-16: expectException on
...
/// matched. Repros: empty ID list (`ContactIds: "[]"`) and 201 GUIDs.
///
        ...
        var test = new TestCase
        {
            ...
            Steps = new List<TestStep>
            {
                new TestStep
                {
                    ...
                    RequestName = "contoso_RequestFieldGovernanceBatch",
