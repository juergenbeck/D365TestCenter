...
public class TestCenterOrchestratorTests
{
    ...
    {
        var cases = MakeCases("ORD01", "ORD-STATUS-01", "ITEM-STATUS-01", "MGR01");
        var result = TestCenterOrchestrator.ApplyFilter(cases, "ORD*,!ORD-STATUS-01");
        Assert.Single(result);
        Assert.Equal("ORD01", result[0].Id);
    }
