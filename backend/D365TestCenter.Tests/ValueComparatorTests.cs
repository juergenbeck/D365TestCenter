...
public class ValueComparatorTests
{
    ...
    {
        // Erzwingt das Dezimal-Komma (de-DE/de-CH = Entwicklermaschine UND der reale
        // Defekt auf einer DEV-Org). Beweist, dass Vergleich UND Substring-Operatoren invariant
